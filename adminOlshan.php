<?php
session_start();
$pass='Olshan'; // Пароль для входа в CMS
...
// Помощь
if(!isset($_GET['mode'])){
	echo('<div id="help"><p><br><h2>CMSLAND</h2><p>CMS предназначена для управления уже готовыми лэндингами, состоящими из HTML страницы, и подключенных к ней CSS файлов.<p>	С помощью данной CMS вы можете редактировать текст, и заменять картинки, изменять HTML код, JS и CSS вашего лэндинга.<p>Разработано Иваном Сараевым (<a href="http://pythono.ru">pythono.ru</a>).</div>');
};
